...
/**
 *struct passinfo - contain pseudo-args to pass into function,
 ...
 *@linecount_flag: if on count use this line of input
...
/* toem_builtin1.c calls */
int _myhistory(info_t *);
int _myalias(info_t *);

/*toem_getline.c calls */
ssize_t get_input(info_t *);
int _getline(info_t *, char **, size_t *);
void sigintHandler(int);

/* toem_getinfo.c calls */
void clear_info(info_t *);
void set_info(info_t *, char **);
void free_info(info_t *, int);

/* toem_environ.c calls */
